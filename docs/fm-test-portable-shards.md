...
| portable serial 1-6 | job `timeout-minutes: 30` | Current runners can take about 20 minutes, and the fork's 2-vCPU runner spreads 2-4x within one job; the 30-minute cap remains a hang tripwire while leaving margin for job setup and runner-speed spread. |
