...
`tests/fm-claude-stop-autoarm.test.sh` covers the auto-arm's scope, stale and live session owners, mid-session takeover across distinct Claude execution lanes, unchanged AFK and need boundaries, single-flight, and exit-2 translation.
