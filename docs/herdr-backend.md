...
- The universal firstmate prerequisites - a verified crew harness, owned by the [`harness-adapters` skill](../.agents/skills/harness-adapters/SKILL.md), plus the required toolchain, owned by [`docs/configuration.md`](configuration.md#toolchain); treehouse still provides the worktree, herdr only provides the session.
