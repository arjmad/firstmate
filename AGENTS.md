...
state/               volatile runtime signals; gitignored
  ...
  .herdr-fleet-<fleet-name>  durable exact-ID creation-proof record for an opt-in Herdr fleet grid workspace; container proof only, never task or endpoint authority; see docs/herdr-backend.md "Opt-in fleet grid workspaces"
