...
- [docs/google-workspace-access.md](docs/google-workspace-access.md) - the optional per-account Google Workspace wiring: setup, the exact invocation, re-authorizing, and revoking an account.
