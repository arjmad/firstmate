...
# prime-agent: an anchored braille spinner followed by Waiting or Executing.
...
FM_TMUX_BUSY_REGEX_DEFAULT='esc (to )?interrupt|Working\.\.\.|Ctrl\+c:cancel|^[[:space:]]*[⠋⠙⠹⠸⠼⠴⠦⠧⠇⠏][[:space:]]+(Waiting|Executing)([[:space:]]+·|$)'
