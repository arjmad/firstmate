...
'   The EXIT trap is best-effort. Firstmate task teardown also runs `"$HERDR_LAB_HELPER" teardown-task '"$ID"'`, so lab cleanup does not depend on this worker shell surviving.' \
