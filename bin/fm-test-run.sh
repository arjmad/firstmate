...
tests/fm-afk-return.test.sh 1718
tests/fm-ask-user-authority.test.sh 79
tests/fm-backend-cmux-smoke.test.sh 32
tests/fm-backend-cmux.test.sh 2693
tests/fm-backend-herdr-focus-flash-e2e.test.sh 24
tests/fm-backend-orca.test.sh 18268
tests/fm-backend-tmux-smoke.test.sh 275
tests/fm-backend-zellij-smoke.test.sh 16
tests/fm-backend-zellij.test.sh 8776
tests/fm-backend.test.sh 15120
tests/fm-backlog-handoff.test.sh 35567
tests/fm-bearings-board.test.sh 2385
tests/fm-bearings-snapshot.test.sh 84951
tests/fm-bootstrap-network-parallel.test.sh 6973
tests/fm-bootstrap.test.sh 24759
tests/fm-branch-supervision.test.sh 3702
tests/fm-busy-adapter-wiring.test.sh 23023
tests/fm-busy-state.test.sh 3020
tests/fm-calm-pi-extension.test.sh 309
tests/fm-classify-decision-key.test.sh 976
tests/fm-claude-stop-autoarm-live-e2e.test.sh 19
tests/fm-claude-stop-autoarm.test.sh 60433
tests/fm-cmux-claude-composer-live-e2e.test.sh 14
tests/fm-codex-continuity-live-e2e.test.sh 16
tests/fm-composer-matrix-live-e2e.test.sh 16
tests/fm-control-relaunch.test.sh 74336
tests/fm-control.test.sh 37296
tests/fm-cursor-harness.test.sh 30046
tests/fm-cursor-primary-live-e2e.test.sh 19
tests/fm-cursor-primary.test.sh 42656
tests/fm-daemon.test.sh 14639
tests/fm-documentation-audiences.test.sh 520
tests/fm-fleet-snapshot-view.test.sh 8677
tests/fm-fleet-sync.test.sh 38138
tests/fm-gate-refuse.test.sh 4317
tests/fm-gitignore-config.test.sh 66
tests/fm-gotmp.test.sh 502
tests/fm-grok-continuity-live-e2e.test.sh 20
tests/fm-grok-stop-live-e2e.test.sh 12
tests/fm-guard-stale-banner.test.sh 12528
tests/fm-harness-liveness-drift-live-e2e.test.sh 23
tests/fm-herdr-session-cleanup.test.sh 5135
tests/fm-herdr-submit-confirm-live-e2e.test.sh 24
tests/fm-herdr-version-floor-live-e2e.test.sh 14
tests/fm-inactive-reconcile.test.sh 41455
tests/fm-kimi-harness.test.sh 14865
tests/fm-lint-workflows.test.sh 793
tests/fm-muse-harness.test.sh 48495
tests/fm-muse-signals-live-e2e.test.sh 22
tests/fm-on.test.sh 5941
tests/fm-opencode-primary-live-e2e.test.sh 13
tests/fm-operational-input.test.sh 210
tests/fm-peek-remote.test.sh 531
tests/fm-pending-reply.test.sh 28331
tests/fm-pi-branch-extension.test.sh 4489
tests/fm-pi-branch-live-e2e.test.sh 40
tests/fm-pi-primary-live-e2e.test.sh 15
tests/fm-pi-watch-extension.test.sh 37550
tests/fm-pr-check-security.test.sh 152978
tests/fm-procevent-when.test.sh 29129
tests/fm-procevent.test.sh 76796
tests/fm-project-origin.test.sh 119
tests/fm-public-followup.test.sh 340507
tests/fm-quota-array-dispatch-live-e2e.test.sh 15
tests/fm-remote-backlog-handoff.test.sh 101778
tests/fm-remote-doctor.test.sh 5445
tests/fm-remote-entrypoint.test.sh 115
tests/fm-remote-job-orphan-reap.test.sh 3021
tests/fm-remote-job.test.sh 57379
tests/fm-remote-reply.test.sh 111032
tests/fm-remote-secondmate-lifecycle-e2e.test.sh 193758
tests/fm-remote-secondmate-parent-binding.test.sh 9075
tests/fm-remote-secondmate-trace-context.test.sh 61495
tests/fm-secondmate-harness.test.sh 141170
tests/fm-secondmate-lifecycle-e2e.test.sh 7205
tests/fm-secondmate-liveness.test.sh 9694
tests/fm-secondmate-safety.test.sh 50640
tests/fm-secondmate-sync.test.sh 16521
tests/fm-send-inbox-doorbell-live-e2e.test.sh 25
tests/fm-send-inbox.test.sh 34422
tests/fm-send-remote-delivery.test.sh 7791
tests/fm-send-resolve-key.test.sh 16394
tests/fm-send-secondmate-marker-herdr-e2e.test.sh 29
tests/fm-send-secondmate-marker.test.sh 6587
tests/fm-session-lock-ancestry.test.sh 1235
tests/fm-session-start.test.sh 128483
tests/fm-sessionstart-hook-live-e2e.test.sh 22
tests/fm-sessionstart-instruction-refresh-live-e2e.test.sh 15
tests/fm-sessionstart-nudge.test.sh 33251
tests/fm-shared-captain-inheritance.test.sh 5498
tests/fm-spawn-dispatch-profile.test.sh 55383
tests/fm-spawn-pool-base-freshen.test.sh 18616
tests/fm-spawn-worktree-settle.test.sh 4863
tests/fm-startup-memory-budget.test.sh 4934
tests/fm-startup-network.test.sh 48543
tests/fm-stow-cascade.test.sh 3182
tests/fm-subagent-pretool-check.test.sh 591
tests/fm-supervision-events.test.sh 406
tests/fm-tangle-guard.test.sh 8441
tests/fm-task-delivery.test.sh 1635
tests/fm-task-inbox.test.sh 25106
tests/fm-teardown-endpoint-safety.test.sh 4233
tests/fm-teardown.test.sh 67830
tests/fm-test-fixture-cleanup.test.sh 447
tests/fm-test-isolation-proof.test.sh 558
tests/fm-tmux-agent-liveness.test.sh 3518
tests/fm-tool-update-check.test.sh 12901
tests/fm-trace-context-lib.test.sh 161
tests/fm-trace-context-spawn.test.sh 32583
tests/fm-turnend-guard.test.sh 18748
tests/fm-update.test.sh 3619
tests/fm-vendor-auth-probe.test.sh 42827
tests/fm-voice-relay.test.sh 36530
tests/fm-wake-daemon-lifecycle-e2e.test.sh 6766
tests/fm-wake-drain-open-decisions-cursor.test.sh 18340
tests/fm-wake-drain-open-decisions.test.sh 5841
tests/fm-wake-drain-unread-status.test.sh 10713
tests/fm-wake-queue.test.sh 72102
tests/fm-watch-arm.test.sh 59913
tests/fm-watch-checkpoint.test.sh 5094
tests/fm-watch-recovery-loop.test.sh 59003
tests/fm-watch-triage.test.sh 149040
tests/fm-watcher-lock.test.sh 73113
EOF
}
