...
# v0.7.5/protocol-17 binary, which is also its floor because the adapter passes
# every crewmate's launch environment through `tab create --env`
# (data/fm-backend-design-d7/herdr-verification-p2.md)
