...
#
# GUI-first, macOS-only (docs/cmux-backend.md "Setup"). How a spawn ends up on
# this adapter - explicit selection, auto-detection eligibility, markers, and
# notices - is owned by bin/fm-backend.sh's fm_backend_name; it is deliberately
# not restated here. Unlike Orca, Escape IS natively supported.
#
