...
# worktree write probe, and the process probe run ONLY here, inside the
...
# its worktree; the write probe goes before the process probe because it is the
# cheaper of the two, and any one alone defers.
