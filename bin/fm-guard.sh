...
TANGLE_ROOT="${FM_TANGLE_ROOT_OVERRIDE:-$FM_ROOT}"
...
# project PRIMARY checkout (TANGLE_ROOT) must stay on its default branch. If a
...
tangle_branch=$(fm_primary_tangle_branch "$TANGLE_ROOT" || true)
