...
# report. A tracked-files fast-forward never touches the private operational
# paths owned by docs/configuration.md, so a secondmate's in-flight work is never
# disrupted. Worktrees of this repo share one object
