...
test_existing_launch_templates_are_byte_pinned() {
  ...
  assert_source_line "    claude) printf '%s' '__ENDPOINTENV__CLAUDE_CODE_ENABLE_PROMPT_SUGGESTION=false claude --dangerously-skip-permissions __STRICTMCP____MCPCONFIG____MODELFLAG____EFFORTFLAG__\"\$(__OPINPUT__ encode launch-brief < __BRIEF__)\"' ;;"
